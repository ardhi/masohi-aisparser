...
var SUPPORTED_FIELDS = ['aisType', 'channel', 'repeatInd', 'mmsi', 'midCountry', 'midCountryIso', 'mmsiType', 'class', 'navStatus', 'navStatusStr', 'rotStatus', 'rot', 'heading', 'sogStatus', 'sog', 'cog', 'latitude', 'longitude', 'posAccuracy', 'utcTsSec', 'utcTsStatus', 'maneuver'];
...
var AisCNBMsg = function (_AisMessage) {
  ...
  _createClass(AisCNBMsg, [{
    ...
    key: 'maneuver',
    get: function get() {
      return this._bitField.getInt(143, 2, true);
    }
  }]);
